class ZodiacsController < ApplicationController
  ...
  def sign
    ...
    title_sign = params[:the_sign]
    @title_sign = title_sign.capitalize
    @prediction = Zodiac.find_by({:sign => title_sign}).fortune
    render 'sign'
  end
  def creature
    @my_creature = Zodiac.find_by({:creature => params[:the_creature]})
  end
end
